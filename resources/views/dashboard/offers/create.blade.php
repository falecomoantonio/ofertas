...
@section('CONTENT')
    ...
    <div class="card">
        <div class="card-header card-header-primary">
            <h4 class="card-title">Nova Oferta</h4>
        </div>
        <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group bmd-form-group">
                            ...
                            <input type="text" value="{{ old('title', '') }}" maxlength="200" class="form-control" name="title" required autofocus />
                            @if($errors->has('title'))
                        ...
                        <div class="form-group bmd-form-group">
                            ...
                            <input type="text" value="{{ old('link', '') }}" maxlength="200" class="form-control" name="link" required />
                            @if($errors->has('link'))
                    ...
                    <div class="col-md-4">
                        <div class="form-group bmd-form-group">
                            ...
                            <input type="text" value="{{ old('code', '') }}" maxlength="200" class="form-control" name="code" required />
                            @if($errors->has('code'))
                    ...
                    <div class="col-md-4">
                        <div class="form-group bmd-form-group">
                            ...
                            <input type="text" value="{{ old('price', '') }}" maxlength="200" class="form-control" name="price" required />
                            @if($errors->has('price'))
                    ...
                    <div class=" col-md-6">
                        <div class="form-group_ is-focused col-md-6">
                            <label class="bmd-label-floating">Banner</label>
                            <input type="file" accept="image/*" name="banner" required />
                            @if($errors->has('banner'))
                                <p class="error text-danger"><small><strong>{{ $errors->first('banner') }}</strong></small></p>
                            @endif
                        </div>
                    </div>
                    <div class=" col-md-6">
                        <div class="form-group_ is-focused col-md-6">
                            <label class="bmd-label-floating">Galeria</label>
                            <input type="file" accept="image/*" multiple name="gallery[]" required />
                            @if($errors->has('gallery'))
                                <p class="error text-danger"><small><strong>{{ $errors->first('gallery') }}</strong></small></p>
                            @endif
                        </div>
                    </div>
                    <div class="col-md-12">
                        ...
                        <div class="form-group bmd-form-group">
                            ...
                            <textarea class="form-control" rows="10" name="content" required>{{ old('content', '') }}</textarea>
